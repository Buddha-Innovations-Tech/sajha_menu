...
frappe.ui.form.on("Tables", {
  ...
  refresh: function (frm) {
    ...
    //   frm
    //     .add_custom_button("Create KOT/BOT", () => {
    //       frappe.call({
    //         method: "sajha_menu.api.create_kot_or_bot_order",
    //         args: {
    //           table_name: frm.docname,
    //           orderItem: frm.doc.current_orders,
    //           company: frm.doc.company,
    //         },
    //         callback: function (r) {
    //           frm.reload_doc();
    ...
    // }
    // frm
    //   .add_custom_button("Switch to POS", () => {
  ...
  //         frappe.throw(
  //           __(
  //             "Cannot toggle `split bill`, since one of the customer already have sales invoice created"
  //           )
  //         );
  //         return;
  //       }
...
//       frappe.throw(
//         __("Please save/update the form before creating sales invoice")
//       );
//       return false;
//     }
...
//       frappe.throw(
//         __(
//           "This room folio have multiple customer, please select one customer name"
//         )
//       );
//       return;
//     }
